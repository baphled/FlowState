...
Feature: Learning Capture via Mem0
  ...
  # P9b: godog glue wired in features/support/recall_learning_steps.go
  # drives Mem0LearningStore against an in-process fake vector store so
  # the scenarios exercise the real internal/learning/mem0_store.go path
  # without a live Mem0 instance.
