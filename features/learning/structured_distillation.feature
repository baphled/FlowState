...
Feature: Structured Knowledge Distillation
  ...
  # P9b: the distillation glue in features/support/recall_learning_steps.go
  # runs StructuredDistiller against an in-process VectorStoreMemoryClient
  # so entity / relation upserts are observable without a live Qdrant.
