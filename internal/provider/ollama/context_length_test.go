...
var _ = Describe("resolveOllamaContextLength", func() {
	DescribeTable("resolves model tags to the correct context length",
		...
		Entry("llama 3.3 resolves to 131k", "llama3.3:latest", 131072),
		...
		Entry("llama 3.3 is not misrouted to llama 3 family", "llama3.3:70b", 131072),
		Entry("qwen 3 8b resolves to 32k", "qwen3:8b", 32768),
		Entry("qwen 3 14b resolves to 32k", "qwen3:14b", 32768),
		Entry("qwen 3 baked 32k variant resolves to 32k", "qwen3:8b-32k", 32768),
		...
		Entry("nous-hermes2-mixtral resolves to 32k", "nous-hermes2-mixtral:latest", 32768),
		Entry("phi 3 resolves to 131k", "phi3:mini", 131072),
		Entry("gemma 4 resolves to 131k", "gemma4:latest", 131072),
		Entry("gemma 3n resolves to 32k", "gemma3n:e4b", 32768),
		Entry("gemma 3 resolves to 131k", "gemma3:12b", 131072),
		Entry("gemma 3n is not misrouted to gemma 3 family", "gemma3n:e4b", 32768),
		Entry("gemma 2 resolves to 8k", "gemma2:9b", 8192),
		Entry("codegemma resolves to 8k", "codegemma:7b", 8192),
		Entry("devstral resolves to 131k", "devstral:latest", 131072),
		Entry("codellama resolves to 16k", "codellama:7b", 16384),
		Entry("deepseek resolves to 16k", "deepseek:7b", 16384),
		Entry("namespaced deepseek strips namespace before matching", "okamototk/deepseek-r1:8b", 16384),
		Entry("namespaced llama 3.1 strips namespace before matching", "ajindal/llama3.1-storm:8b", 131072),
