...
var _ = Describe("WriteAfterTokenMeasurementEvidence", func() {
	It("captures post-skill-cache token measurements as JSON evidence", func() {
		...
		Expect(skillCache.Init()).To(Succeed())
