...
# probe, commit 592c8c20). This is a REASONING-CRITICAL agent — evidence
# synthesis — so the top tier is opus rather than sonnet. anthropic FIRST
# (claude-opus-4-6) — best reasoning when reachable, auto-recovers the
# moment the provider is back up. openai/gpt-4o SECOND — proven reachable +
# reliable (0/3 synthesis-hangs) when anthropic was unreachable tonight.
# zai/glm-4.6 TERMINAL — also proven reliable (0/3 hangs) and always
